...
/*:
* @plugindesc v.1.0.0 Advanced project testing and various settings. Made with ♥ by DKPlugins
* @author DKPlugins
...
/*:ru
* @plugindesc v.1.0.0 Расширенное тестирование проекта и различные настройки. Сделано с ♥ от DKPlugins
* @author DKPlugins
* @url https://dk-plugins.ru
* @target MZ
* @help
...
DKTools.Utils = class {
    ...
    static __showGrid() {
        ...
        mouseSprite.addEvent({
            ...
            onUpdate: () => {
                if (line) {
                    const point2 = { x: TouchInput.x, y: TouchInput.y };
...
DKTools.Utils.Point = class {
     ...
     * @static
     *
     * @param {Number | Point | Object} [object=0] - The X coordinate or Point or object with parameters
     ...
     * @static
     *
     * @param {Point | Object} point1 - Point or object with parameters
     * @param {Number | Point | Object} [object=0] - The X coordinate or Point or object with parameters
     ...
     * @static
     *
     * @param {Point | Object} object - Point or object with parameters
     *
     * @param {Number} object.x - The X coordinate
     * @param {Number} object.y - The Y coordinate
     *
    ...
    static tryToPoint(object, y) {
        ...
        if ( [pointX, pointY].every(item => DKTools.Utils.isNumber(item))) {
...
DKTools.Utils.Rectangle = class {
     ...
     * @static
     *
     * @param {Number | Rectangle | Object} [object=0] - The X coordinate or Rectangle or object with parameters
     * @param {Number} [y=0] - The Y coordinate (if object is Number)
     ...
     * @static
     *
     * @param {Rectangle | Object} rect1 -  Rectangle or object with parameters
     * @param {Number | Rectangle | Object} [object=0] - The X coordinate or Rectangle or object with parameters
     * @param {Number} [y=0] - The Y coordinate (if object is Number)
     * @param {Number} [width=0] - The rectangle width (if object is Number)
     * @param {Number} [height=0] - The rectangle height (if object is Number)
     ...
     * @static
     *
     * @param {Rectangle | Object} object - Rectangle or object with parameters
     *
     * @param {Number} [object.x] - The X coordinate
     * @param {Number} [object.y] - The Y coordinate
     * @param {Number} [object.width] - The rectangle width
     ...
     *
     * @returns {Boolean} Rectangle is empty
     */
    static isEmpty(object) {
        return this.equals(object, new Rectangle(0, 0, 0, 0));
    }
    ...
    static tryToRectangle(object, y, width, height) {
        ...
        if ([rectX, rectY, rectWidth, rectHeight].every(item => DKTools.Utils.isNumber(item))) {
...
DKTools.Utils.WebAudio = class {
     ...
     *
     * @returns {Promise<WebAudio>} Loaded audio file or null
     */
     ...
     *
     * @returns {Promise<WebAudio[]>} Loaded audio files
     */
...
DKTools.Utils.Bitmap = class {
    ...
    static async loadBitmapsAsync(bitmaps) {
        ...
        const promises = bitmaps.map(bitmap => this.loadAsync(bitmap));
...
DKTools.Utils.Event = class {
     ...
     *
     * @returns {Object} Comments of the all pages
     */
     ...
     *
     * @returns {String[]} Comments of the current page
     */
...
DKTools.IO = class {
    ...
    static async _createStamp() {
        ...
        if (JSON.stringify(stamp) !== JSON.stringify(this._stamp)) {
...
DKTools.IO.File = class extends DKTools.IO.Entity {
     ...
     */
    isImage() {
        return this._extension === '.png' || this._extension === '.png_' || this._extension === '.webp';
    }
     ...
     *
     * @returns {Boolean} Extension of the file is equal to .rmmzsave
     */
    isSave() {
...
DKTools.IO.WebStorage = class {
    ...
    static load(key, object = {}) {
        ...
        if (data) {
            if (object.decompress) {
                try {
                    data = pako.inflate(data, object.decompress instanceof Object ? object.decompress : { to: 'string' });
                } catch (error) {
                    return { data: null, status: DKTools.IO.ERROR_DECOMPRESSING_DATA, error };
                }
            }
    ...
    static save(key, data, object = {}) {
        ...
        if (object.compress) {
            data = pako.deflate(data, object.compress instanceof Object ? object.compress : { to: 'string', level: 1 });
        }
...
DKTools.PluginManager = class {
     ...
     * DKTools.PluginManager.requirePlugin('DKTools', '1.0.0');
     *
     * @example
    ...
    static requirePlugin(pluginName, data) {
        ...
        if (data instanceof Object) {
            ...
            console.error('Unknown version type:' + typeof data);
...
DKTools.PreloadManager = class {
     ...
     * @see DKTools.PreloadManager._generateKey
...
DKTools.Animation.Action = class extends DKTools.Event {
    ...
    static Frame(object) {
        ...
        action.setOnUpdateHandler(function() {
            ...
            if (target instanceof DKTools.Sprite) {
    ...
    static Move(object) {
        ...
        action.setOnUpdateHandler(function() {
            ...
            if (target instanceof Sprite || target instanceof DKTools.Window) {
        ...
        action.setOnSuccessHandler(function() {
            ...
            if (target instanceof Sprite || target instanceof DKTools.Window) {
                target.move(this._data.x, this._data.y);
            } else {
                target.position.set(this._data.x, this._data.y);
            }
        }.bind(action));
    ...
    static Opacity(object) {
        ...
        action.setOnUpdateHandler(function() {
            ...
            if (target instanceof DKTools.Window) {
                const keys = ['windowOpacity', 'contentsOpacity', 'contentsBackOpacity',
                    'frameOpacity', 'backOpacity'];

                keys.forEach((key) => {
                    if (Number.isFinite(this._data[key])) {
                        newOpacity[key] = target[key] +
                            (this._data[key] - target[key]) / remainingTime;
                    }
                });
            } else {
                newOpacity = target.opacity + (this._data - target.opacity) / remainingTime;
            }

            if (DKTools.Utils.isFunction(target.setOpacity)) {
        ...
        action.setOnSuccessHandler(function() {
            ...
            if (DKTools.Utils.isFunction(target.setOpacity)) {
                target.setOpacity(this._data);
            } else {
                target.opacity = this._data;
            }
        }.bind(action));
    ...
    static Rotation(object) {
        ...
        action.setOnUpdateHandler(function() {
            ...
            if (DKTools.Utils.isFunction(target.setRotation)) {
        ...
        action.setOnSuccessHandler(function() {
            ...
            if (DKTools.Utils.isFunction(target.setRotation)) {
                target.setRotation(this._data);
            } else {
                target.rotation = this._data;
            }
        }.bind(action));
    ...
    static Scale(object) {
        ...
        action.setOnUpdateHandler(function() {
            ...
            if (DKTools.Utils.isFunction(target.setScale)) {
        ...
        action.setOnSuccessHandler(function() {
            ...
            if (DKTools.Utils.isFunction(target.setScale)) {
                target.setScale(this._data);
            } else {
                target.scale.set(this._data.x, this._data.y);
            }
        }.bind(action));
    ...
    initialize(object) {
        ...
        super.initialize.apply(this, object);
    }
...
DKTools.Base = class {
    ...
    /**
     * Gets the object ID
     * @return {Number | String | null} Object id
     */
    get id() {
        return this._id;
    }
     ...
     * @return {Point} Coordinates of mouse inside the object
     */
    get mouse() {
     ...
     * @param {Number} [options.x] - The X coordinate
     * @param {Number | String} [options.y] - The Y coordinate or line number (String)
     * @param {Point | Object} [options.pos] - Position of the arc (ignores other parameters of position: x, y)
     * @param {Number} [options.paintOpacity] - Change paint opacity
     * @param {Boolean} [options.resetPaintOpacity] - Reset paint opacity
     *
     * @param {Number} [options.pos.x] - The X coordinate
     ...
     *
     * @see DKTools.Base.prototype.lineHeight
     * @see DKTools.Base.prototype.hasBitmap
     *
     ...
     * @see DKTools.Base.prototype.lineHeight
     *
     * @return {Rectangle} Rectangle of the line
     */
    getLineRect(line) {
        const lineHeight = this.lineHeight();
     ...
     * @see DKTools.Base.prototype.lineHeight
     *
     * @return {Number} Maximum of lines
     */
    getLines() {
     ...
     *
     * @return {{ width: Number, height: Number }} Size of the object (taking into account the scaling)
     */
    getSize() {
    ...
    getTextHeight(text, wrap = {}) {
        return this.getTextLines(text, wrap) * this.lineHeight();
    }
     ...
     * @param {Number} [options.width] - Width of the rectangle
     * @param {Number | String} [options.height] - Height of the rectangle or number of lines (String)
     * @param {Rectangle | Object} [options.rect] - Rectangle for drawing (ignores other parameters of position: x, y, width, height)
     * @param {Number} [options.paintOpacity] - Change paint opacity
     * @param {Boolean} [options.resetPaintOpacity] - Reset paint opacity
     *
     * @param {Number} [options.rect.x] - The X coordinate
     ...
     * @return {Boolean} Object has the mask
     */
    hasMask() {
        return !!this.mask;
    }
     ...
     * @return {Boolean} Object is based on DKTools.Sprite.Button
     */
    isButton() {
     ...
     */
    isChild(object) {
        return object ? this.children.includes(object) : this.hasParent();
    }
     ...
     * @return {Boolean} Object is based on DKTools.Sprite
     */
    isSprite() {
     ...
     * @return {Boolean} Object is based on DKTools.Window
     */
    isWindow() {
     ...
     * @see Window_Base.prototype.makeFontBigger
     */
    makeFontBigger() {
        if (this.hasBitmap()) {
     ...
     * @see Window_Base.prototype.makeFontSmaller
     */
    makeFontSmaller() {
        if (this.hasBitmap()) {
     ...
     * @see Window_Base.prototype.maxFontSizeInLine
     ...
     * @see Window_Base.prototype.obtainEscapeCode
     * @return {String}
     */
    ...
    /**
     * @param {Object} textState
     * @see Window_Base.prototype.obtainEscapeParam
     ...
     * @see Window_Base.prototype.partyMemberName
    ...
    /**
     * @param {Object} textState
     * @see Window_Base.prototype.processCharacter
     */
    ...
    /**
     * @param {Object} textState
     * @see Window_Base.prototype.processAllText
     */
     ...
     * @param {Object} textState
     * @param {String} c
     * @see Window_Base.prototype.processControlCharacter
     */
    ...
    /**
     * @param {Object} textState
     * @see Window_Base.prototype.processNewLine
     */
     ...
     *
     * @param {Number | Point | Object} [object] - Pivot of the object on X axis or object with parameters
     ...
     *
     * @param {Number | Point | Object} [object] - Scale of the object on X axis or object width parameters
     ...
     *
     * @param {Number | Point | Object} [object] - Skew of the object on X axis or object with parameters
     ...
     * @param {Number} [object.skew.y] - Skew of the object on Y axis
     *
     * @return {Number} Number of changed parameters
     */
     ...
     * Returns true if the change occurred
     *
     * @param {Number | Point | Object} [object] - Scale of the object on X axis or object with parameters
     * @param {Number} [y] - Scale of the object on Y axis (if object is Number)
     *
     * @param {Number} [object.x] - Scale of the object on X axis
     * @param {Number} [object.y] - Scale of the object on Y axis
     ...
     * @param {Number} [options.x] - The X coordinate
     * @param {Number | String} [options.y] - The Y coordinate or line number (String)
     * @param {Point | Object} [options.pos] - Position of arc (ignores other parameters of position: x, y)
     * @param {Number} [options.paintOpacity] - Change paint opacity
     * @param {Boolean} [options.resetPaintOpacity] - Reset paint opacity
     *
     * @param {Number} [options.pos.x] - The X coordinate
    ...
    updateAddAllChildrenEvents() {
        this._eventsManager.updateEventsContainer('add-all-children');
    }
    ...
    updateRemoveAllChildrenEvents() {
        this._eventsManager.updateEventsContainer('remove-all-children');
    }
    ...
    updateStartAllEvents() {
        this._eventsManager.updateEventsContainer('start-all');
    }
    ...
    updateTerminateAllEvents() {
        this._eventsManager.updateEventsContainer('terminate-all-children');
    }
...
DKTools.Sprite.prototype._clearAll = function() {
    DKTools.Base.prototype._clearAll.apply(this, arguments);
    this._clearTexts();
};
...
/**
 * @param {Boolean} rtl
 * @see Window_Base.prototype.createTextBuffer
 * @return {String}
 */
 ...
 * @param {Number} y
 * @param {Number} width
 * @see Window_Base.prototype.createTextState
 * @return {Object}
 */
...
/**
 * @param {Object} textState
 * @see Window_Base.prototype.flushTextState
 */
 ...
 * @see Window_Base.prototype.lineHeight
 ...
 * @see Game_System.prototype.mainFontFace
 ...
 * @returns {Boolean} Standard font italic
 */
 ...
 * @see Game_System.prototype.mainFontSize
 ...
 * @param {Rectangle | Object} [object.frame] - Rectangle or object with parameters
 * @param {Point | Object} [object.anchor] - Anchor of the sprite
 ...
 *
 * @param {Number | Point | Object} [object=this.standardAnchor()] - The X coordinate or Point or object with parameters
 ...
 * @see DKTools.Sprite.prototype.lineHeight
 */
 ...
 *
 * @param {Point | Object} [object.anchor] - Anchor
 * @param {Object} [object.font] - Text font
 * @param {String} [object.textColor] - Text color
 * @param {Number} [object.paintOpacity] - Paint opacity
 * @param {String} [object.fillColor] - Fill color
 ...
 * Updates the sprite
 * @override
 * @see DKTools.Base.prototype.update
 */
...
DKTools.Sprite.ProgressBar = class extends DKTools.Sprite {
     ...
     */
    drawAll() {
        super.drawAll.apply(this, arguments);
        this.drawProgress();
    }
     ...
     * @returns {Function | null} Standard handler of draw of the graphic
     */
     ...
     * @returns {Function | null} Standard handler of draw of the text
     */
    ...
    updateEmptyEvents() {
        if (this.isEmpty()) {
            this._eventsManager.updateEventsContainer('empty');
        }
    }
     ...
     */
    updateEvents() {
        super.updateEvents.apply(this, arguments);
    ...
    updateFullEvents() {
        if (this.isFull()) {
            this._eventsManager.updateEventsContainer('full');
        }
    }
     ...
     */
    updateValueEvents() {
        this._eventsManager.updateEventsContainer('value');
    }
...
Object.defineProperties(DKTools.Window.prototype, {
    ...
    windowOpacity: {
        ...
        set: function(value) {
            this._container.alpha = DKTools.Utils.Number.clamp(value, 0, 255) / 255;
        },
        configurable: true
    },
    ...
    /**
     * Opacity of the contents background
     * @type {Number}
     * @memberof DKTools.Window.prototype
     */
    contentsBackOpacity: {
        ...
        set: function(value) {
            this._contentsBackSprite.alpha = DKTools.Utils.Number.clamp(value, 0, 255) / 255;
        },
        configurable: true
    },
    ...
    frameOpacity: {
        ...
        set: function(value) {
            this._frameSprite.alpha = DKTools.Utils.Number.clamp(value, 0, 255) / 255;
        },
        configurable: true
    },
    ...
    /**
     * Sprite of the contents background
     * @readonly
     * @type {Sprite}
     * @memberof DKTools.Window.prototype
     */
    contentsBackSprite: {
        get: function() {
            return this._contentsBackSprite;
        },
        configurable: true
    },
 ...
 * @private
 * @override
 * @see Window.prototype._createContentsBackSprite
 * @see DKTools.Window.prototype.standardContentsBackOpacity
 */
DKTools.Window.prototype._createContentsBackSprite = function() {
    ...
    this._contentsBackSprite.opacity = this.standardContentsBackOpacity();
};
 ...
 * Returns true if successfully completed
 * @override
 * @see DKTools.Base.prototype.clear
 * @return {Boolean} Successfully completed
 */
 ...
 * @override
 * @see DKTools.Window.prototype.contentsWidth
 * @see DKTools.Window.prototype.contentsHeight
 */
 ...
 * @param {Object} [options={}] - Options for drawing
 * @see DKTools.Sprite.prototype.drawText
 * @see Window_Base.prototype.drawText
 */
...
/**
 * Returns true if the window has a parent (if parameter is null or undefined)
 * Returns true if the sprite is child of this window
 * @override
 * @param {Sprite} [sprite] - Sprite
 * @see DKTools.Base.prototype.isChild
 * @return {Boolean} Sprite is child of this window or window has a parent (if parameter is null or undefined)
 */
DKTools.Window.prototype.isChild = function(sprite) {
    return DKTools.Base.prototype.isChild.apply(this, arguments)
        || (!!sprite && !!sprite.parent &&
            [this._container, this._clientArea].includes(sprite.parent));
};
 ...
 * @override
 * @see Window_Base.prototype.loadWindowskin
 */
 ...
 * @override
 * @see DKTools.Window.prototype.resetTextColor
 * @see Window_Base.prototype.resetTextColor
 */
...
DKTools.Window.prototype.resize = function(width, height, blockStart = false, activate = false) {
    if (DKTools.Utils.isString(height)) { // number of lines
        height = this.itemHeight() * parseFloat(height)
            + _.defaultTo(this._padding, this.standardPadding()) * 2;
    }
 ...
 * @return {Number} Standard openness of the window
 */
 ...
 * @return {Number} Standard margin of the window
 */
 ...
 * @return {Point} Standard origin of the window
 */
 ...
 * @see Game_System.prototype.windowPadding
 * @return {Number} Standard padding of the window
 */
...
/**
 * Returns the standard opacity of the window background
 * @return {Number} Standard opacity of the window background
 */
DKTools.Window.prototype.standardBackOpacity = function() {
    return 192;
};
 ...
 * @return {Number} Standard opacity of the window
 */
 ...
 * @return {Number} Standard opacity of the contents
 */
...
/**
 * Returns the standard opacity of the contents background
 * @see DKTools.Window.prototype.standardContentsOpacity
 * @return {Number} Standard opacity of the contents background
 */
DKTools.Window.prototype.standardContentsBackOpacity = function() {
    return this.standardContentsOpacity();
};

/**
 * Returns the standard opacity of the frame
 * @return {Number} Standard opacity of the frame
 */
 ...
 * @see DKTools.Window.prototype.standardBackOpacity
 * @return {{ windowOpacity: Number, contentsOpacity: Number, contentsBackOpacity: Number, frameOpacity: Number, backOpacity: Number }} Standard opacity
 */
DKTools.Window.prototype.standardOpacity = function() {
    return {
        ...
        contentsBackOpacity: this.standardContentsBackOpacity(),
 ...
 * @param {Number} [object.opacity.contentsBackOpacity] - Opacity of the contents background
 ...
 *
 * @param {Number} [padding=$gameSystem.windowPadding()] - Padding
 ...
 * @param {Number} [opacity.contentsBackOpacity] - Opacity of the contents background
...
DKTools.Window.prototype.setContentsSprite = function(contentsSprite, blockStart = false, activate = false) {
    if (this._contentsSprite == contentsSprite) {
        return false;
    }
 ...
 * @param {Boolean} [blockUpdate=false] - Blocking the call of the "updateOpacity" function
 *
 * @param {Number} [opacity.windowOpacity] - Opacity of the window
 * @param {Number} [opacity.contentsOpacity] - Opacity of the contents
 * @param {Number} [opacity.contentsBackOpacity] - Opacity of the contents background
 ...
 * @return {Boolean} Change occurred
 */
DKTools.Window.prototype.setOpacity = function(opacity, blockUpdate = false) {
...
/**
 * Updates the opacity of thw window
 *
 * @override
 *
...
DKTools.Window.prototype.updateOpacity = function(opacity = {}) {
    ...
    this.contentsBackOpacity = _.defaultTo(opacity.contentsBackOpacity, this.opacity.contentsBackOpacity);
 ...
 * Updates the window
 * @override
 * @see Window_Base.prototype.update
 * @see DKTools.Base.prototype.update
 */
...
DKTools.Window.Selectable.prototype = Object.create(Window_Command.prototype);
 ...
 * @private
 * @override
 * @see DKTools.Window.prototype._clearAll
 * @see DKTools.Window.Selectable.prototype.clearScrollStatus
 */
 ...
 */
DKTools.Window.Selectable.prototype.commandName = function(index) {
 ...
 */
DKTools.Window.Selectable.prototype.commandExt = function(index) {
    const item = this.getItem(index);
...
DKTools.Window.Selectable.prototype.contentsWidth = function() {
    return this.isHorizontal() ?
        ...
        Window_Command.prototype.contentsWidth.apply(this, arguments);
};
 ...
 * @see DKTools.Window.Selectable.prototype.isHorizontal
 * @see DKTools.Window.Selectable.prototype.maxItems
 * @see DKTools.Window.Selectable.prototype.maxCols
 * @see DKTools.Window.Selectable.prototype.maxRows
 * @see DKTools.Window.Selectable.prototype.smoothSelect
 */
 ...
 * @see DKTools.Window.Selectable.prototype.isHorizontal
 * @see DKTools.Window.Selectable.prototype.smoothSelect
 * @see DKTools.Window.Selectable.prototype.selectPrevItem
 */
 ...
 * @see DKTools.Window.Selectable.prototype.isHorizontal
 * @see DKTools.Window.Selectable.prototype.smoothSelect
 * @see DKTools.Window.Selectable.prototype.selectNextItem
 */
 ...
 * Draws all
 * @override
 * @see DKTools.Window.Selectable.prototype.drawAllItems
 */
 ...
 * Draws all items
 * @override
 * @see DKTools.Window.Selectable.prototype.maxVisibleItems
 * @see DKTools.Window.Selectable.prototype.maxItems
 * @see DKTools.Window.Selectable.prototype.topIndex
 * @see DKTools.Window.Selectable.prototype.drawItemBackground
 * @see DKTools.Window.Selectable.prototype.drawItem
 */
 ...
 * @see DKTools.Window.Selectable.prototype.isHorizontal
 * @see DKTools.Window.Selectable.prototype.getCurrentCol
 * @see DKTools.Window.Selectable.prototype.scrollX
 * @see DKTools.Window.Selectable.prototype.itemWidth
 * @see DKTools.Window.Selectable.prototype.smoothScrollTo
 * @see DKTools.Window.Selectable.prototype.scrollTo
 * @see Window_Command.prototype.ensureCursorVisible
 */
DKTools.Window.Selectable.prototype.ensureCursorVisible = function(smooth = false) {
    if (this.isHorizontal()) {
        ...
        Window_Command.prototype.ensureCursorVisible.apply(this, arguments);
    }
};
 ...
 */
DKTools.Window.Selectable.prototype.getCol = function(index) {
 ...
 */
DKTools.Window.Selectable.prototype.getCurrentCol = function() {
    return this.isHorizontal() ?
        this._index : this.getCol(this._index);
};
 ...
 */
DKTools.Window.Selectable.prototype.getPrevIndex = function(wrap = false) {
    if (this._index > 0) {
 ...
 */
DKTools.Window.Selectable.prototype.getNextIndex = function(wrap = false) {
 ...
 */
DKTools.Window.Selectable.prototype.getItem = function(index) {
 ...
 */
DKTools.Window.Selectable.prototype.getCurrentItem = function() {
 ...
 */
DKTools.Window.Selectable.prototype.getPrevItem = function(wrap = false) {
 ...
 */
DKTools.Window.Selectable.prototype.getNextItem = function(wrap = false) {
...
DKTools.Window.Selectable.prototype.hasSymbol = function(symbol) {
    return this._list ?
        this.findSymbol(symbol) >= 0 : false;
};
...
DKTools.Window.Selectable.prototype.itemWidth = function() {
    ...
    } else if (DKTools.Utils.isNumber(this._itemWidth)) {
        return this._itemWidth;
    }

    return Window_Command.prototype.itemWidth.apply(this, arguments);
};
...
DKTools.Window.Selectable.prototype.itemTextAlign = function(index) {
    ...
    return item.align || Window_Command.prototype.itemTextAlign.apply(this, arguments);
};
 ...
 * @override
 */
DKTools.Window.Selectable.prototype.makeCommandList = function() {
    this._list = (this._items || []).map((command) => {
        if (command.enabled === undefined) {
            command.enabled = true;
        }

        if (command.symbol && DKTools.Utils.isFunction(command.handler)) {
            this.setHandler(command.symbol, command.handler);
        }
...
DKTools.Window.Selectable.prototype.maxItems = function() {
    return this._list ?
        this._list.length : (this._items ? this._items.length : 0);
};

/**
 * Returns max page cols
 * @return {Number} Max page cols
 */
DKTools.Window.Selectable.prototype.maxPageCols = function() {
    return this.maxCols();
};
...
DKTools.Window.Selectable.prototype.maxPageItems = function() {
    return this.isHorizontal() ?
        this.maxPageCols() : Window_Command.prototype.maxPageItems.apply(this, arguments);
};

/**
 * Max page rows
 * @override
 * @return {Number} Max page rows
 */
DKTools.Window.Selectable.prototype.maxPageRows = function() {
...
DKTools.Window.Selectable.prototype.maxVisibleItems = function() {
    return this.isHorizontal() ?
        ...
        Window_Command.prototype.maxVisibleItems.apply(this, arguments);
 ...
 * @override
 * @see DKTools.Window.Selectable.prototype.isHorizontal
 * @see DKTools.Window.Selectable.prototype.itemHeight
 * @see Window_Command.prototype.overallHeight
 * @return {Number} Overall height
 */
DKTools.Window.Selectable.prototype.overallHeight = function() {
    return this.isHorizontal() ?
        this.itemHeight() : Window_Command.prototype.overallHeight.apply(this, arguments);
};
...
/**
 * @override
 * @see DKTools.Window.Selectable.prototype.refreshAll
 */
 ...
 * @override
 * @see DKTools.Window.Selectable.prototype.isWheelScrollEnabled
 * @see DKTools.Window.Selectable.prototype.isTouchedInsideFrame
 * @see DKTools.Window.Selectable.prototype.isHorizontal
 * @see DKTools.Window.Selectable.prototype.smoothScrollLeft
 * @see DKTools.Window.Selectable.prototype.smoothScrollDown
 * @see DKTools.Window.Selectable.prototype.smoothScrollRight
 * @see DKTools.Window.Selectable.prototype.smoothScrollUp
 */
 ...
 * @override
 * @see DKTools.Window.Selectable.prototype.clearCommandList
 * @see DKTools.Window.Selectable.prototype.makeCommandList
 * @see DKTools.Window.prototype.refreshAll
 * @see DKTools.Window.Selectable.prototype.refreshCursor
 */
 ...
 * @see DKTools.Window.Selectable.prototype.setupItems
 * @see DKTools.Window.Selectable.prototype.start
 * @return {Boolean} Change occurred
 */
 ...
 * @param {Boolean} [blockStart=false] - Blocking call of the "start" function
 * @see DKTools.Window.Selectable.prototype.setupMaxCols
 * @see DKTools.Window.Selectable.prototype.start
 * @return {Boolean} Change occurred
 */
 ...
 * @see Window_Command.prototype.select
 */
...
DKTools.Window.Selectable.prototype.topIndex = function() {
   return this.isHorizontal() ?
       this.topCol() : Window_Command.prototype.topIndex.apply(this, arguments);
};
 ...
 * Updates the window
 * @override
 * @see Window_Command.prototype.update
 * @see DKTools.Base.prototype.update
 */
 ...
 *
 * @see DKTools.Scene.prototype.needsCancelButton
 * @see DKTools.Scene.prototype.needsPageButtons
 * @see DKTools.Scene.prototype.createCancelButton
 * @see DKTools.Scene.prototype.createPageButtons
 */
 ...
 *
 * @see DKTools.Scene.prototype.buttonY
 */
 ...
 *
 * @returns {Boolean} Needs create the cancel button
 */
 ...
 *
 * @returns {Boolean} Needs create the page buttons
 */
 ...
 * @see DKTools.Scene.prototype.updateEvents
 */
